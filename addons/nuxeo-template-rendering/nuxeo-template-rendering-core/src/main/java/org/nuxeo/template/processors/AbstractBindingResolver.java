...
public abstract class AbstractBindingResolver implements InputBindingResolver {
    ...
    protected Object extractValueFromParam(TemplateBasedDocument templateBasedDocument, TemplateInput param) throws ValueNotFound, NoValueToAddInContext {
    ...
    protected Object extractBlobContent(DocumentModel doc, TemplateInput param) throws ValueNotFound {
    ...
    protected Object extractDefaultValue(DocumentModel doc, TemplateInput param) throws ValueNotFound {
    ...
    protected Serializable getDocPropertyValue(DocumentModel doc, String propKey) throws ValueNotFound {
        try {
    ...
    protected static class ValueNotFound extends Throwable {
    ...
    protected static class NoValueToAddInContext extends Throwable {
    }
