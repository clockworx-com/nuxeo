...
/**
 * Should use now Framework.getService(SerializerService.class).getSerializer("xml")
 *
...
public class XMLSerializer {
    ...
    public static String serialize(List<TemplateInput> params) {
        return getXmlSerializer().doSerialization(params);
    }

    public static List<TemplateInput> readFromXml(String xml) throws DocumentException {
        return getXmlSerializer().doDeserialization(xml);
    }
