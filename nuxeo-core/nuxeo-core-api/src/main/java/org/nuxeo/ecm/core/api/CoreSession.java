...
public interface CoreSession {
     ...
     * @since 11.1
     */
    Calendar RETENTION_UNTIL_INDETERMINATE = GregorianCalendar.from(ZonedDateTime.parse("9999-01-01T00:00Z"));
     ...
     * @since 11.1
     */
    void setRetentionUntil(DocumentRef docRef, Calendar retainUntil) throws PropertyException;
     ...
     * @since 11.1
     */
    Calendar getRetentionUntil(DocumentRef docRef);
     ...
     * @since 11.1
     */
    void setLegalHold(DocumentRef docRef, boolean hold);
